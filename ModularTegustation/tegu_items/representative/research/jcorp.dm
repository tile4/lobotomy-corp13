...
/datum/data/lc13research/abno_mechanic_luck/ResearchEffect(obj/structure/representative_console/caller)
	. = ..()
...
/datum/data/lc13research/tool_abno_gacha/ResearchEffect(obj/structure/representative_console/caller)
	. = ..()
